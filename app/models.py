...
class FeedbackRequest(BaseModel):
    ...
    target_type: Optional[str] = Field(default=None, description="generation_suggestion, recommendation, opportunity, fact_check, app_experience, contact, or interaction")
